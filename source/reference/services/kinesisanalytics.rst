...
.. _Understanding Application Output (Destination): http://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-output.html
.. _Getting Started: http://docs.aws.amazon.com/kinesisanalytics/latest/dev/getting-started.html
.. _Configuring Application Input: http://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html
.. _Limits: http://docs.aws.amazon.com/kinesisanalytics/latest/dev/limits.html
.. _How it Works: http://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works.html
.. _Configuring Application Output: http://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-output.html
...
.. py:class:: KinesisAnalytics.Client
  ...
  *   :py:meth:`add_application_input`

  
  *   :py:meth:`add_application_output`

  
  *   :py:meth:`add_application_reference_data_source`
  ...
  *   :py:meth:`delete_application_output`

  
  *   :py:meth:`delete_application_reference_data_source`

  
  *   :py:meth:`describe_application`

  
  *   :py:meth:`discover_input_schema`
  ...
  *   :py:meth:`start_application`

  
  *   :py:meth:`stop_application`
  ...
  *   :py:meth:`update_application`
  ...
  .. py:method:: add_application_input(**kwargs)
    ...
    Adds a streaming source to your Amazon Kinesis application. For conceptual information, see `Configuring Application Input`_ . 
    ...
    **Request Syntax** 
    ...
    :param Input: **[REQUIRED]** 
      ...
      When you configure the application input, you specify the streaming source, the in-application stream name that is created, and the mapping between the two. For more information, see `Configuring Application Input`_ . 
      ...
      - **InputParallelism** *(dict) --* 
        ...
        (see `Configuring Application Input`_ .
        ...
        - **Count** *(integer) --* 
          ...
          Number of in-application streams to create. For more information, see `Limits`_ . 
  ...
  .. py:method:: add_application_output(**kwargs)
    ...
    You can use one of the output configurations to deliver data from your in-application error stream to an external destination so that you can analyze the errors. For conceptual information, see `Understanding Application Output (Destination)`_ . 
    ...
    For the limits on the number of application inputs and outputs you can configure, see `Limits`_ .
    ...
    **Request Syntax** 
    ...
    :param Output: **[REQUIRED]** 
      ...
      - **DestinationSchema** *(dict) --* **[REQUIRED]** 
        ...
        Describes the data format when records are written to the destination. For more information, see `Configuring Application Output`_ . 
  ...
  .. py:method:: add_application_reference_data_source(**kwargs)
    ...
    For conceptual information, see `Configuring Application Input`_ . For the limits on data sources you can add to your application, see `Limits`_ . 
  ...
  .. py:method:: create_application(**kwargs)
    ...
    Creates an Amazon Kinesis Analytics application. You can configure each application with one streaming source as input, application code to process the input, and up to five streaming destinations where you want Amazon Kinesis Analytics to write the output data from your application. For an overview, see `How it Works`_ . 
    ...
    For introductory exercises to create an Amazon Kinesis Analytics application, see `Getting Started`_ . 
      ...
      - *(dict) --* 
        ...
        - **ApplicationDetail** *(dict) --* 
          ...
          - **InputDescriptions** *(list) --* 
            ...
            Describes the application input configuration. For more information, see `Configuring Application Input`_ . 
          ...
          - **OutputDescriptions** *(list) --* 
            ...
            Describes the application output configuration. For more information, see `Configuring Application Output`_ . 
          ...
          - **ReferenceDataSourceDescriptions** *(list) --* 
            ...
            Describes reference data sources configured for the application. For more information, see `Configuring Application Input`_ . 
