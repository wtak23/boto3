...
.. _Create a Custom Action for a Pipeline: http://docs.aws.amazon.com/codepipeline/latest/userguide/how-to-create-custom-action.html
.. _Concepts: http://docs.aws.amazon.com/codepipeline/latest/userguide/concepts.html#CPS3Bucket
...
.. py:class:: CodePipeline.Client
  ...
  *   :py:meth:`acknowledge_job`

  
  *   :py:meth:`acknowledge_third_party_job`

  
  *   :py:meth:`can_paginate`

  
  *   :py:meth:`create_custom_action_type`

  
  *   :py:meth:`create_pipeline`

  
  *   :py:meth:`delete_custom_action_type`

  
  *   :py:meth:`delete_pipeline`

  
  *   :py:meth:`disable_stage_transition`

  
  *   :py:meth:`enable_stage_transition`

  
  *   :py:meth:`generate_presigned_url`

  
  *   :py:meth:`get_job_details`

  
  *   :py:meth:`get_paginator`

  
  *   :py:meth:`get_pipeline`

  
  *   :py:meth:`get_pipeline_execution`

  
  *   :py:meth:`get_pipeline_state`

  
  *   :py:meth:`get_third_party_job_details`

  
  *   :py:meth:`get_waiter`

  
  *   :py:meth:`list_action_types`

  
  *   :py:meth:`list_pipelines`

  
  *   :py:meth:`poll_for_jobs`

  
  *   :py:meth:`poll_for_third_party_jobs`

  
  *   :py:meth:`put_action_revision`

  
  *   :py:meth:`put_approval_result`

  
  *   :py:meth:`put_job_failure_result`

  
  *   :py:meth:`put_job_success_result`

  
  *   :py:meth:`put_third_party_job_failure_result`

  
  *   :py:meth:`put_third_party_job_success_result`

  
  *   :py:meth:`retry_stage_execution`

  
  *   :py:meth:`start_pipeline_execution`

  
  *   :py:meth:`update_pipeline`
    ...
    **Request Syntax** 
    ...
    :param configurationProperties: 
      ...
      .. note::
        ...
        You can refer to a name in the configuration properties of the custom action within the URL templates by following the format of {Config:name}, as long as the configuration property is both required and not secret. For more information, see `Create a Custom Action for a Pipeline`_ .
    ...
    **Request Syntax** 
    ...
    :param pipeline: **[REQUIRED]** 
      ...
      - **artifactStore** *(dict) --* **[REQUIRED]** 
        ...
        The Amazon S3 location where artifacts are stored for the pipeline. If this Amazon S3 bucket is created manually, it must meet the requirements for AWS CodePipeline. For more information, see the `Concepts`_ .
