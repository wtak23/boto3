...
.. py:class:: CognitoSync.Client
  ...
  *   :py:meth:`bulk_publish`

  
  *   :py:meth:`can_paginate`

  
  *   :py:meth:`delete_dataset`

  
  *   :py:meth:`describe_dataset`

  
  *   :py:meth:`describe_identity_pool_usage`

  
  *   :py:meth:`describe_identity_usage`

  
  *   :py:meth:`generate_presigned_url`

  
  *   :py:meth:`get_bulk_publish_details`

  
  *   :py:meth:`get_cognito_events`

  
  *   :py:meth:`get_identity_pool_configuration`
  ...
  *   :py:meth:`list_datasets`

  
  *   :py:meth:`list_identity_pool_usage`

  
  *   :py:meth:`list_records`

  
  *   :py:meth:`register_device`

  
  *   :py:meth:`set_cognito_events`

  
  *   :py:meth:`set_identity_pool_configuration`

  
  *   :py:meth:`subscribe_to_dataset`

  
  *   :py:meth:`unsubscribe_from_dataset`

  
  *   :py:meth:`update_records`
