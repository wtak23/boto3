...
.. _http\://docs.aws.amazon.com/general/latest/gr/aws-access-keys-best-practices.html: http://docs.aws.amazon.com/general/latest/gr/aws-access-keys-best-practices.html
...
.. _Amazon EC2 Dedicated Hosts: http://aws.amazon.com/ec2/dedicated-hosts/
.. _DescribeVolumes: http://docs.aws.amazon.com/AWSEC2/latest/APIReference/ApiReference-query-DescribeVolumes.html
...
.. _Amazon EC2 Dedicated Instances: http://aws.amazon.com/ec2/purchasing-options/dedicated-instances/
...
.. _http\://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html: http://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html
.. _Dedicated Instances: http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/dedicated-instance.html
...
.. _Dedicated Hosts Overview: http://aws.amazon.com/ec2/dedicated-hosts/
...
.. py:class:: OpsWorks.Client
  ...
  *   :py:meth:`assign_instance`

  
  *   :py:meth:`assign_volume`

  
  *   :py:meth:`associate_elastic_ip`

  
  *   :py:meth:`attach_elastic_load_balancer`
  ...
  *   :py:meth:`create_user_profile`

  
  *   :py:meth:`delete_app`

  
  *   :py:meth:`delete_instance`

  
  *   :py:meth:`delete_layer`

  
  *   :py:meth:`delete_stack`

  
  *   :py:meth:`delete_user_profile`

  
  *   :py:meth:`deregister_ecs_cluster`

  
  *   :py:meth:`deregister_elastic_ip`

  
  *   :py:meth:`deregister_instance`

  
  *   :py:meth:`deregister_rds_db_instance`

  
  *   :py:meth:`deregister_volume`

  
  *   :py:meth:`describe_agent_versions`

  
  *   :py:meth:`describe_apps`

  
  *   :py:meth:`describe_commands`

  
  *   :py:meth:`describe_deployments`

  
  *   :py:meth:`describe_ecs_clusters`

  
  *   :py:meth:`describe_elastic_ips`

  
  *   :py:meth:`describe_elastic_load_balancers`

  
  *   :py:meth:`describe_instances`

  
  *   :py:meth:`describe_layers`

  
  *   :py:meth:`describe_load_based_auto_scaling`

  
  *   :py:meth:`describe_my_user_profile`

  
  *   :py:meth:`describe_permissions`

  
  *   :py:meth:`describe_raid_arrays`

  
  *   :py:meth:`describe_rds_db_instances`

  
  *   :py:meth:`describe_service_errors`

  
  *   :py:meth:`describe_stack_provisioning_parameters`

  
  *   :py:meth:`describe_stack_summary`

  
  *   :py:meth:`describe_stacks`

  
  *   :py:meth:`describe_time_based_auto_scaling`

  
  *   :py:meth:`describe_user_profiles`

  
  *   :py:meth:`describe_volumes`

  
  *   :py:meth:`detach_elastic_load_balancer`

  
  *   :py:meth:`disassociate_elastic_ip`

  
  *   :py:meth:`generate_presigned_url`

  
  *   :py:meth:`get_hostname_suggestion`
  ...
  *   :py:meth:`grant_access`

  
  *   :py:meth:`reboot_instance`

  
  *   :py:meth:`register_ecs_cluster`

  
  *   :py:meth:`register_elastic_ip`

  
  *   :py:meth:`register_instance`

  
  *   :py:meth:`register_rds_db_instance`

  
  *   :py:meth:`register_volume`

  
  *   :py:meth:`set_load_based_auto_scaling`

  
  *   :py:meth:`set_permission`

  
  *   :py:meth:`set_time_based_auto_scaling`

  
  *   :py:meth:`start_instance`

  
  *   :py:meth:`start_stack`

  
  *   :py:meth:`stop_instance`

  
  *   :py:meth:`stop_stack`

  
  *   :py:meth:`unassign_instance`

  
  *   :py:meth:`unassign_volume`

  
  *   :py:meth:`update_app`

  
  *   :py:meth:`update_elastic_ip`

  
  *   :py:meth:`update_instance`

  
  *   :py:meth:`update_layer`

  
  *   :py:meth:`update_my_user_profile`

  
  *   :py:meth:`update_rds_db_instance`

  
  *   :py:meth:`update_stack`

  
  *   :py:meth:`update_user_profile`

  
  *   :py:meth:`update_volume`
  ...
  .. py:method:: clone_stack(**kwargs)
    ...
    **Request Syntax** 
    ...
    :param Region: 
      ...
      The cloned stack AWS region, such as "ap-northeast-2". For more information about AWS regions, see `Regions and Endpoints`_ .
    ...
    :param ChefConfiguration: 
      ...
      A ``ChefConfiguration`` object that specifies whether to enable Berkshelf and the Berkshelf version on Chef 11.10 stacks. For more information, see `Create a New Stack`_ .
  ...
  .. py:method:: create_instance(**kwargs)
    ...
    **Request Syntax** 
    ...
    :param Tenancy: 
      ...
      The instance's tenancy option. The default option is no tenancy, or if the instance is running in a VPC, inherit tenancy settings from the VPC. The following are valid values for this parameter: ``dedicated`` , ``default`` , or ``host`` . Because there are costs associated with changes in tenancy options, we recommend that you research tenancy options before choosing them for your instances. For more information about dedicated hosts, see `Dedicated Hosts Overview`_ and `Amazon EC2 Dedicated Hosts`_ . For more information about dedicated instances, see `Dedicated Instances`_ and `Amazon EC2 Dedicated Instances`_ .
  ...
  .. py:method:: create_stack(**kwargs)
    ...
    **Request Syntax** 
    ...
    :param Region: **[REQUIRED]** 
      ...
      The stack's AWS region, such as "ap-south-1". For more information about Amazon regions, see `Regions and Endpoints`_ .
        ...
        - **Stacks** *(list) --* 
          ...
          - *(dict) --* 
            ...
            - **Region** *(string) --* 
              ...
              The stack AWS region, such as "ap-northeast-2". For more information about AWS regions, see `Regions and Endpoints`_ .
        ...
        - **Volumes** *(list) --* 
          ...
          - *(dict) --* 
            ...
            - **Status** *(string) --* 
              ...
              The value returned by `DescribeVolumes`_ .
  ...
  .. py:method:: register_instance(**kwargs)
    ...
    .. note::
      ...
      We do not recommend using this action to register instances. The complete registration operation has two primary steps, installing the AWS OpsWorks agent on the instance and registering the instance with the stack. ``RegisterInstance`` handles only the second step. You should instead use the AWS CLI ``register`` command, which performs the entire registration operation. For more information, see `Registering an Instance with an AWS OpsWorks Stack`_ .
  ...
  .. py:method:: update_stack(**kwargs)
    ...
    **Request Syntax** 
    ...
    :param DefaultAvailabilityZone: 
      ...
      The stack's default Availability Zone, which must be in the stack's region. For more information, see `Regions and Endpoints`_ . If you also specify a value for ``DefaultSubnetId`` , the subnet must be in the same zone. For more information, see  CreateStack . 
