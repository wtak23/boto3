...
.. py:class:: Redshift.Client
  ...
  *   :py:meth:`authorize_cluster_security_group_ingress`

  
  *   :py:meth:`authorize_snapshot_access`

  
  *   :py:meth:`can_paginate`

  
  *   :py:meth:`copy_cluster_snapshot`

  
  *   :py:meth:`create_cluster`

  
  *   :py:meth:`create_cluster_parameter_group`

  
  *   :py:meth:`create_cluster_security_group`

  
  *   :py:meth:`create_cluster_snapshot`

  
  *   :py:meth:`create_cluster_subnet_group`

  
  *   :py:meth:`create_event_subscription`

  
  *   :py:meth:`create_hsm_client_certificate`

  
  *   :py:meth:`create_hsm_configuration`

  
  *   :py:meth:`create_snapshot_copy_grant`
  ...
  *   :py:meth:`delete_cluster_parameter_group`

  
  *   :py:meth:`delete_cluster_security_group`

  
  *   :py:meth:`delete_cluster_snapshot`

  
  *   :py:meth:`delete_cluster_subnet_group`

  
  *   :py:meth:`delete_event_subscription`

  
  *   :py:meth:`delete_hsm_client_certificate`

  
  *   :py:meth:`delete_hsm_configuration`

  
  *   :py:meth:`delete_snapshot_copy_grant`

  
  *   :py:meth:`delete_tags`

  
  *   :py:meth:`describe_cluster_parameter_groups`

  
  *   :py:meth:`describe_cluster_parameters`

  
  *   :py:meth:`describe_cluster_security_groups`

  
  *   :py:meth:`describe_cluster_snapshots`

  
  *   :py:meth:`describe_cluster_subnet_groups`

  
  *   :py:meth:`describe_cluster_versions`

  
  *   :py:meth:`describe_clusters`

  
  *   :py:meth:`describe_default_cluster_parameters`
  ...
  *   :py:meth:`describe_hsm_client_certificates`

  
  *   :py:meth:`describe_hsm_configurations`

  
  *   :py:meth:`describe_logging_status`

  
  *   :py:meth:`describe_orderable_cluster_options`

  
  *   :py:meth:`describe_reserved_node_offerings`

  
  *   :py:meth:`describe_reserved_nodes`

  
  *   :py:meth:`describe_resize`

  
  *   :py:meth:`describe_snapshot_copy_grants`

  
  *   :py:meth:`describe_table_restore_status`

  
  *   :py:meth:`describe_tags`

  
  *   :py:meth:`disable_logging`

  
  *   :py:meth:`disable_snapshot_copy`

  
  *   :py:meth:`enable_logging`

  
  *   :py:meth:`enable_snapshot_copy`
  ...
  *   :py:meth:`modify_cluster`

  
  *   :py:meth:`modify_cluster_iam_roles`

  
  *   :py:meth:`modify_cluster_parameter_group`

  
  *   :py:meth:`modify_cluster_subnet_group`

  
  *   :py:meth:`modify_event_subscription`

  
  *   :py:meth:`modify_snapshot_copy_retention_period`

  
  *   :py:meth:`purchase_reserved_node_offering`

  
  *   :py:meth:`reboot_cluster`

  
  *   :py:meth:`reset_cluster_parameter_group`

  
  *   :py:meth:`restore_from_cluster_snapshot`

  
  *   :py:meth:`restore_table_from_cluster_snapshot`

  
  *   :py:meth:`revoke_cluster_security_group_ingress`

  
  *   :py:meth:`revoke_snapshot_access`

  
  *   :py:meth:`rotate_encryption_key`
  ...
  .. py:method:: authorize_cluster_security_group_ingress(**kwargs)
    ...
    If you authorize access to a CIDR/IP address range, specify *CIDRIP* . For an overview of CIDR blocks, see the Wikipedia article on `Classless Inter-Domain Routing`_ . 
  ...
  .. py:method:: delete_cluster(**kwargs)
    ...
    Deletes a previously provisioned cluster. A successful response from the web service indicates that the request was received correctly. Use  DescribeClusters to monitor the status of the deletion. The delete operation cannot be canceled or reverted once submitted. For more information about managing clusters, go to `Amazon Redshift Clusters`_ in the *Amazon Redshift Cluster Management Guide* . 
  ...
  .. py:method:: reboot_cluster(**kwargs)
    ...
    Reboots a cluster. This action is taken as soon as possible. It results in a momentary outage to the cluster, during which the cluster status is set to ``rebooting`` . A cluster event is created when the reboot is completed. Any pending cluster modifications (see  ModifyCluster ) are applied at this reboot. For more information about managing clusters, go to `Amazon Redshift Clusters`_ in the *Amazon Redshift Cluster Management Guide*  
